...
Each participant completes **64 experimental trials** across **2 blocks** (32 trials each), preceded by 2 practice trials and separated by a break period. In each trial, a virtual agent approaches the participant who is asked to press a button when the distance becomes uncomfortable. Then, participant is asked to answer two questions: "How friendly the person seemed to you?" and "How uncomfortable the distance felt?" on a Likert scale (1-5).
...
| Social context | "Are there any people around you?" | 1. "no, I'm alone"<br>2. "yes, people I know"<br>3. "yes, people I don't know"<br>4. "yes, some people I know and people I don't know" |
| Appraisals (social/non-social) | "trustworthy", "unapproachable", "friendly", "aloof" / "pleasant", "stressful", "comfortable", "draining" | 0-100 |
